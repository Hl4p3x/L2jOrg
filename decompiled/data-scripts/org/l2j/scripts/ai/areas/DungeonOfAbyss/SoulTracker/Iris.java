...
public class Iris extends AbstractNpcAI
{
    ...
    private Iris() {
        this.addStartNpc(31776);
        this.addTalkId(31776);
        this.addFirstTalkId(31776);
    }
            ...
            switch (event) {
                case "1": {
                    if (qs != null && qs.isStarted()) {
                        player.teleToLocation((ILocational)Iris.LOCATIONS.get(event), false);
                        break;
                    }
                    return "no_enter.htm";
                }
    ...
    static {
        (LOCATIONS = new HashMap<String, Location>()).put("1", new Location(-110038, -180560, -6754));
        Iris.LOCATIONS.put("2", new Location(-109234, -177737, -6751));
        Iris.LOCATIONS.put("3", new Location(-112648, -181517, -6751));
        Iris.LOCATIONS.put("4", new Location(146945, 26764, -2200));
    }
}

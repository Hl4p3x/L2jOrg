...
public class Enemy implements ITargetTypeHandler
{
    public Enum<TargetType> getTargetType() {
        return (Enum<TargetType>)TargetType.ENEMY;
    }
    ...
    public WorldObject getTarget(final Creature activeChar, final WorldObject selectedTarget, final Skill skill, final boolean forceUse, final boolean dontMove, final boolean sendMessage) {
        ...
        if (forceUse && target.getActingPlayer() != null && activeChar.getActingPlayer() != null && activeChar.getActingPlayer().isSiegeFriend((WorldObject)target)) {
            if (sendMessage) {

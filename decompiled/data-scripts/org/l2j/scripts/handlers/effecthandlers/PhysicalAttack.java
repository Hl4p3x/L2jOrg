...
public final class PhysicalAttack extends AbstractEffect
{
    ...
    private PhysicalAttack(final StatsSet params) {
        this.power = params.getDouble("power", 0.0);
        this.pAtkMod = params.getDouble("attack-mod", 1.0);
        this.pDefMod = params.getDouble("defense-mod", 1.0);
    ...
    public void instant(final Creature effector, final Creature effected, final Skill skill, final Item item) {
        ...
        final double attack = effector.getPAtk() * this.pAtkMod;
        ...
        double damage = 1.0;
        final boolean critical = Formulas.calcCrit(this.criticalChance, effected, effector, skill);
        if (defence != -1.0) {

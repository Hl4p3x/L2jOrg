...
public class TwoHandedSwordBonus extends AbstractEffect
{
    ...
    private TwoHandedSwordBonus(final StatsSet params) {
    ...
    public void pump(final Creature effected, final Skill skill) {
        if (TwoHandedSwordBonus.weaponTypeCondition.test(effected, effected, skill) && TwoHandedSwordBonus.slotCondition.test(effected, effected, skill)) {
    ...
    static {
        weaponTypeCondition = (Condition)new ConditionUsingItemType(WeaponType.SWORD.mask());

...
public class ReleaseAttribute implements IBypassHandler
{
    ...
    public boolean useBypass(final String command, final Player player, final Creature target) {
        ...
        player.sendPacket(new ServerPacket[] { (ServerPacket)new ExShowBaseAttributeCancelWindow(player) });
        return true;
    }
    
    public String[] getBypassList() {
        return ReleaseAttribute.COMMANDS;
    }
    
    static {
        COMMANDS = new String[] { "ReleaseAttribute" };
    }
}

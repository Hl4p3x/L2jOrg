...
public class WatermelonNinja extends LongTimeEvent
{
    ...
    private WatermelonNinja() {
        this.addAttackId((IntCollection)WatermelonNinja.SQUASH_LIST);
        this.addKillId((IntCollection)WatermelonNinja.SQUASH_LIST);
        this.addSpawnId((IntCollection)WatermelonNinja.SQUASH_LIST);
        this.addSpawnId((IntCollection)WatermelonNinja.LARGE_SQUASH_LIST);
        this.addSkillSeeId((IntCollection)WatermelonNinja.SQUASH_LIST);
    ...
    public String onSpawn(final Npc npc) {
        ...
        if (WatermelonNinja.LARGE_SQUASH_LIST.contains(npc.getId())) {
            npc.setIsInvul(true);
        }
        return null;
    }
    ...
    public String onAttack(final Npc npc, final Player attacker, final int damage, final boolean isPet) {
        if (WatermelonNinja.LARGE_SQUASH_LIST.contains(npc.getId())) {
            if (attacker.getActiveWeaponItem() != null && WatermelonNinja.CHRONO_LIST.contains(attacker.getActiveWeaponItem().getId())) {
                this.ChronoText(npc);
    ...
    public String onSkillSee(final Npc npc, final Player caster, final Skill skill, final WorldObject[] targets, final boolean isPet) {
        if (WatermelonNinja.SQUASH_LIST.contains(npc.getId()) && skill.getId() == 2005) {
            switch (npc.getId()) {
                case 13271: {
                    this.randomSpawn(13274, 13273, 13272, npc, true);
                    break;
                }
                case 13275: {
                    this.randomSpawn(13278, 13277, 13276, npc, true);
                    break;
                }
            }
        }
    ...
    public String onKill(final Npc npc, final Player killer, final boolean isPet) {
        if (WatermelonNinja.SQUASH_LIST.contains(npc.getId())) {
            dropItem(npc, killer);
        }
    ...
    private static final void dropItem(final Npc mob, final Player player) {
        ...
        for (final int[] drop : WatermelonNinja.DROPLIST) {
    ...
    private void ChronoText(final Npc npc) {
        if (Rnd.get(100) < 20) {
            npc.broadcastPacket((ServerPacket)new CreatureSay(npc.getObjectId(), ChatType.NPC_GENERAL, npc.getName(), WatermelonNinja._CHRONO_TEXT[Rnd.get(WatermelonNinja._CHRONO_TEXT.length)]));
        }
    }
    
    private void noChronoText(final Npc npc) {
        if (Rnd.get(100) < 20) {
            npc.broadcastPacket((ServerPacket)new CreatureSay(npc.getObjectId(), ChatType.NPC_GENERAL, npc.getName(), WatermelonNinja._NOCHRONO_TEXT[Rnd.get(WatermelonNinja._NOCHRONO_TEXT.length)]));
        }
    }
    
    private void nectarText(final Npc npc) {
        if (Rnd.get(100) < 30) {
            npc.broadcastPacket((ServerPacket)new CreatureSay(npc.getObjectId(), ChatType.NPC_GENERAL, npc.getName(), WatermelonNinja._NECTAR_TEXT[Rnd.get(WatermelonNinja._NECTAR_TEXT.length)]));
        }
    }
    ...
    public static AbstractScript provider() {
        return (AbstractScript)new WatermelonNinja();
    }
    
    static {
        SQUASH_LIST = IntSet.of(13271, 13272, new int[] { 13273, 13274, 13275, 13276, 13277, 13278 });
        LARGE_SQUASH_LIST = IntSet.of(13274, 13278);
        ...

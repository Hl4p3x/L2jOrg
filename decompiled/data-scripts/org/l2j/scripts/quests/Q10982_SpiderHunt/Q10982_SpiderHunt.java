...
public class Q10982_SpiderHunt extends Quest
{
    ...
    public Q10982_SpiderHunt() {
        super(10982);
        this.addCondClassIds(new ClassId[] { ClassId.FIGHTER, ClassId.MAGE });
        this.addStartNpc(30002);
        this.addTalkId(new int[] { 30002, 30332 });
        this.addKillId(new int[] { 20103, 20106, 20108 });
        this.addCondLevel(15, 20, "no_lvl.html");
        this.setQuestNameNpcStringId(NpcStringId.LV_15_20_SPIDER_HUNT);
    }
        ...
        switch (event) {
            ...
            case "HeavyArmor.html": {
                if (qs.isStarted()) {
                    ...
                    giveItems(player, Q10982_SpiderHunt.SOE_NOVICE);
                    giveItems(player, Q10982_SpiderHunt.SPIRIT_ORE);
                    giveItems(player, Q10982_SpiderHunt.HP_POTS);
                    giveItems(player, Q10982_SpiderHunt.RICE_CAKE_OF_FLAMING_FIGHTING_SPIRIT_EVENT);
                    giveItems(player, Q10982_SpiderHunt.MOON_HELMET);
                    giveItems(player, Q10982_SpiderHunt.MOON_ARMOR);
                    giveItems(player, Q10982_SpiderHunt.MOON_GAUNTLETS);
                    giveItems(player, Q10982_SpiderHunt.MOON_BOOTS);
            ...
            case "LightArmor.html": {
                if (qs.isStarted()) {
                    ...
                    giveItems(player, Q10982_SpiderHunt.RICE_CAKE_OF_FLAMING_FIGHTING_SPIRIT_EVENT);
                    giveItems(player, Q10982_SpiderHunt.MOON_HELMET);
                    giveItems(player, Q10982_SpiderHunt.MOON_SHELL);
                    giveItems(player, Q10982_SpiderHunt.MOON_LEATHER_GLOVES);
                    giveItems(player, Q10982_SpiderHunt.MOON_SHOES);
                    if (CategoryManager.getInstance().isInCategory(CategoryType.FIRST_CLASS_GROUP, player.getClassId().getId())) {
                        showOnScreenMsg(player, NpcStringId.YOU_VE_FINISHED_THE_TUTORIAL_NTAKE_YOUR_1ST_CLASS_TRANSFER_AND_COMPLETE_YOUR_TRAINING_WITH_BATHIS_TO_BECOME_STRONGER, 2, 10000, new String[0]);
                        player.sendPacket(new ServerPacket[] { (ServerPacket)ExRequestClassChangeUi.STATIC_PACKET });
                    }
            ...
            case "Robe.html": {
                if (qs.isStarted()) {
                    ...
                    giveItems(player, Q10982_SpiderHunt.RICE_CAKE_OF_FLAMING_FIGHTING_SPIRIT_EVENT);
                    giveItems(player, Q10982_SpiderHunt.MOON_HELMET);
                    giveItems(player, Q10982_SpiderHunt.MOON_CAPE);
                    giveItems(player, Q10982_SpiderHunt.MOON_SILK);
                    giveItems(player, Q10982_SpiderHunt.MOON_SANDALS);
                    if (CategoryManager.getInstance().isInCategory(CategoryType.FIRST_CLASS_GROUP, player.getClassId().getId())) {
                        showOnScreenMsg(player, NpcStringId.YOU_VE_FINISHED_THE_TUTORIAL_NTAKE_YOUR_1ST_CLASS_TRANSFER_AND_COMPLETE_YOUR_TRAINING_WITH_BATHIS_TO_BECOME_STRONGER, 2, 10000, new String[0]);
                        player.sendPacket(new ServerPacket[] { (ServerPacket)ExRequestClassChangeUi.STATIC_PACKET });
                    }
    ...
    public String onKill(final Npc npc, final Player killer, final boolean isSummon) {
        ...
        if (qs != null && qs.isCond(1)) {
            ...
            if (killCount < 30) {
                ...
                giveItems(killer, Q10982_SpiderHunt.SOE_TO_CAPTAIN_BATHIS);
            }
        }
    ...
    public Set<NpcLogListHolder> getNpcLogList(final Player player) {
        ...
        if (qs != null && qs.isCond(1)) {
            ...
            holder.add(new NpcLogListHolder(NpcStringId.KILL_GIANT_SPIDERS.getId(), true, qs.getInt("KillCount")));
            return holder;
        }
    ...
    public String onTalk(final Npc npc, final Player player) {
        ...
        else if (qs.isCompleted() && npc.getId() == 30002) {

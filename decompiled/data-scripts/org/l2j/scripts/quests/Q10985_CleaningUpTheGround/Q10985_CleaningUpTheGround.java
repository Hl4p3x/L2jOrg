...
public class Q10985_CleaningUpTheGround extends Quest
{
    ...
    private static final ItemHolder SOE_TO_VOLLODOS;
    ...
    public Q10985_CleaningUpTheGround() {
        super(10985);
        this.addStartNpc(30600);
        this.addTalkId(new int[] { 30600, 30137 });
        this.addKillId(new int[] { 20456, 20003, 20004 });
        this.addCondMaxLevel(20, "no_lvl.html");
        this.setQuestNameNpcStringId(NpcStringId.LV_2_20_CLEANING_UP_THE_GROUNDS);
    }
        ...
        switch (event) {
            ...
            case "30137-02.htm": {
                if (qs.isStarted()) {
                    ...
                    giveItems(player, Q10985_CleaningUpTheGround.SOE_NOVICE);
                    giveItems(player, Q10985_CleaningUpTheGround.RING_NOVICE);
                    giveItems(player, Q10985_CleaningUpTheGround.EARRING_NOVICE);
                    giveItems(player, Q10985_CleaningUpTheGround.NECKLACE_NOVICE);
    ...
    public String onKill(final Npc npc, final Player killer, final boolean isSummon) {
        ...
        if (qs != null && qs.isCond(1)) {
            ...
            if (killCount < 20) {
                ...
                giveItems(killer, Q10985_CleaningUpTheGround.SOE_TO_VOLLODOS);
            }
        }
    ...
    public Set<NpcLogListHolder> getNpcLogList(final Player player) {
        ...
        if (qs != null && qs.isCond(1)) {
            ...
            holder.add(new NpcLogListHolder(NpcStringId.KILL_MONSTERS_NEAR_THE_VILLAGE.getId(), true, qs.getInt("KillCount")));
            return holder;
        }
    ...
    public String onTalk(final Npc npc, final Player player) {
        ...
        else if (qs.isCompleted() && npc.getId() == 30600) {
    ...
    static {
        SOE_TO_VOLLODOS = new ItemHolder(91648, 1L);

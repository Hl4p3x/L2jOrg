...
public class RequestPledgeWaitingApply extends ClientPacket
{
    ...
    public void runImpl() {
        ...
        final PledgeApplicantInfo info = new PledgeApplicantInfo(activeChar.getObjectId(), activeChar.getName(), activeChar.getLevel(), this._karma, this._clanId, this._message);

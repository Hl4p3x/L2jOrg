...
public class HennaItemDrawInfo extends ServerPacket
{
    ...
    public HennaItemDrawInfo(final Henna henna, final Player player) {
        this._henna = henna;
        this._activeChar = player;
    }
    
    public void writeImpl(final GameClient client) {
        this.writeId(ServerPacketId.HENNA_ITEM_INFO);
        this.writeInt(this._henna.getDyeId());
        this.writeInt(this._henna.getDyeItemId());
        this.writeLong((long)this._henna.getWearCount());
        this.writeLong((long)this._henna.getWearFee());

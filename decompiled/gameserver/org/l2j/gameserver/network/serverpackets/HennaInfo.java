...
public final class HennaInfo extends ServerPacket
{
    ...
    public void writeImpl(final GameClient client) {
        this.writeId(ServerPacketId.HENNA_INFO);
        ...
        this.writeShort((short)0);
        this.writeInt(3 - this._activeChar.getHennaEmptySlots());
        this.writeInt(this._hennas.size());
        for (final Henna henna : this._hennas) {
            this.writeInt(henna.getDyeId());
            this.writeInt((int)(henna.isAllowedClass(this._activeChar.getClassId()) ? 1 : 0));
        }
        this.writeInt(0);
        this.writeInt(0);
        this.writeInt(0);

...
{
    public VillageMasterPriest(final NpcTemplate template) {
        super(template);
    }
    ...
    protected final boolean checkVillageMasterTeachType(final ClassId pclass) {
        return pclass != null && CategoryManager.getInstance().isInCategory(CategoryType.CLERIC_GROUP, pclass.getId());
    }
}

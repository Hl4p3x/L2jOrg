...
public enum CommissionItemType
{
    ...
    private CommissionItemType(final int clientId) {
        this._clientId = clientId;
    }
    
    public static CommissionItemType findByClientId(final int clientId) {
        for (final CommissionItemType value : values()) {

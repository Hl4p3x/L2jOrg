...
public class PrimeShopProduct
{
    ...
    public PrimeShopProduct(final int id, final List<PrimeShopItem> items) {
        this.id = id;
        this.items = items;
    }
    ...
    public int getWeight() {
        return this.items.stream().mapToInt(PrimeShopItem::getWeight).sum();
    }
    ...
    public void setRestrictionDay(final byte restrictionDay) {

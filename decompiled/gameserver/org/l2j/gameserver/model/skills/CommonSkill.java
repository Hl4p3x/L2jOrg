...
public enum CommonSkill
{
    ...
    private CommonSkill(final int id, final int level) {
    ...
    public boolean isSame(final int skillId) {
        return skillId == this._holder.getSkillId();
    }
}

...
public enum AbnormalType
{
    ...
    private AbnormalType(final int clientId) {
        this._clientId = clientId;
    }
    
    public static AbnormalType getAbnormalType(final String type) {
        try {
            return Enum.valueOf(AbnormalType.class, type);
        }
        catch (Exception e) {
            AbnormalType.LOGGER.warn(invokedynamic(makeConcatWithConstants:(Ljava/lang/String;)Ljava/lang/String;, type));
    ...
    public boolean isNone() {
        return this == AbnormalType.NONE;
    }
    
    static {
        LOGGER = LoggerFactory.getLogger((Class)AbnormalType.class);
    }
}

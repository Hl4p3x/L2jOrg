...
public enum AbnormalVisualEffect
{
    ...
    private AbnormalVisualEffect(final int clientId) {
        this._clientId = clientId;
    }
    
    public static AbnormalVisualEffect findByName(final String name) {
        for (final AbnormalVisualEffect abnormalVisualEffect : values()) {

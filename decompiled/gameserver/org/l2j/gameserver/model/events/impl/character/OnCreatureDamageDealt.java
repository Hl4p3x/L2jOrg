...
public class OnCreatureDamageDealt implements IBaseEvent
{
    ...
    public OnCreatureDamageDealt(final Creature attacker, final Creature target, final double damage, final Skill skill, final boolean crit, final boolean damageOverTime, final boolean reflect) {
